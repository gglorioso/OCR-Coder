...
#SBATCH --output=slurm-stage1-dgx-%j.out
...
echo "=== Stage 1 DGX (V100 QLoRA) training started at $(date) ==="
...
"$PYTHON" -m torch.distributed.run \
    ...
    --save-dir MVV/Phase_3/Phase_3_4/DGX_run/checkpoints/stage1 \
    --epochs 3 \
    --batch-size 2

echo "=== Stage 1 DGX (V100 QLoRA) training finished at $(date) ==="
